...
{
    LOG(kSeverityTrace, "CpTopology4::RoomAdded ");
    LOG(kSeverityTrace, aRoom.Name());
    LOG(kSeverityTrace, "\n");
...
{
    LOG(kSeverityTrace, "CpTopology4::RoomChanged ");
    LOG(kSeverityTrace, aRoom.Name());
    LOG(kSeverityTrace, "\n");
...
{
    LOG(kSeverityTrace, "CpTopology4::RoomRemoved ");
    LOG(kSeverityTrace, aRoom.Name());
    LOG(kSeverityTrace, "\n");
